export default [
    ...
    },
    {
        title: 'Abstract Tech',
        image: '/design_7.png',
        prompt: 'Create variables of abstract technology logos. Focus on geometric shapes, networking nodes, and futuristic lines. The design should convey innovation, connectivity, and digital transformation. Use a cool color palette with neons or metallic gradients.'
    },
    {
        title: 'Grungy Streetwear',
        image: '/design_1.png',
        prompt: 'Design a bold, urban streetwear logo with a grungy aesthetic. Use distressed textures, graffiti-style typography, and rebellious iconography. The logo should feel raw, edgy, and high-energy, suitable for a skateboard or lifestyle brand.'
    },
    {
        title: 'Elegant Signature',
        image: '/design_5.png',
        prompt: 'Create a sophisticated signature-style logo. Use a fluid, handwritten script font that looks like a personal signature. Combine it with a clean, minimal icon or monogram. The design should feel luxurious, personal, and high-end.'
    }
]